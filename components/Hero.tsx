      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="flex flex-col items-start max-w-5xl">
          ...
          >
            <a
                href="#about"
                className="inline-flex items-center justify-center px-8 py-4 text-sm font-mono tracking-wider font-bold text-black bg-white hover:bg-gray-200 transition-colors"
            >
                VIEW DETAILS
            </a>
          </motion.div>
          ...
          >
             ...
             <div>
                <p className="font-mono text-xs text-gray-500 uppercase mb-1">Eligibility</p>
                <p className="text-white font-mono">DP1 Students</p>
             </div>
             <div>
